...
import com.hagongda.lightmodbus.GPRSConnectionReadHandler;
import com.hagongda.lightmodbus.GPRSHandlerPool;

import net.wimpi.modbus.Modbus;
import net.wimpi.modbus.util.ThreadPool;

public class MDTcpListener implements Runnable {
	   ...
	   *        incoming requests.
	   */
	  public MDTcpListener(int poolsize) {
	   ...
	   */
	  public MDTcpListener(int poolsize, InetAddress addr) {
	    m_ThreadPool = new ThreadPool(poolsize);
	    m_Address = addr;
	  }//constructor
